...
if __name__ == '__main__':
    ...
    config = {
        'path2basis': '../data/press3T_30ms.BASIS',  # path to the basis set
        'path2concs': '../data/ground_truth/',   # path to the ground truth concentrations
        'path2data': '../data/datasets_JMRUI_WS/',   # path to the data
        'path2water': '../data/datasets_JMRUI_nWS/',   # path to the water reference

        'path2save': None,  # path to save the output files (if None, temporary folder is used)
